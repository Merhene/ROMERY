    ...
    <div>
      ...
      <div class="cards-container">
        ...
        <div class="mealType">
          <h2>Plats</h2>
          <div class="card">
            <img class="recto" src="./Images/bouchee.png" alt="Photo Burjé élégance avec ses frites de Patate Douce au Parmesan ">
            <div class="verso">
        ...
        <div class="mealType">
          <h2>Desserts</h2>
          <div class="card">
            <img class="recto" src="./Images/churros.png" alt="Phot de Churros au chocolat noir et fleur de sel">
            <div class="verso">
        ...
        <div class="mealType">
          <h2>Vins</h2>
          <div class="card">
            <img class="recto" src="./Images/vinbet.png" alt="Photo d'une bouteille de vin Pétillant de Betterave ">
            <div class="verso">
          ...
          <div class="card">
            <img class="recto" src="./Images/vin.png" alt="Photo d'une bouteille de vin Rouge Sang de Dragon  ">
            <div class="verso">
          ...
          <div class="card">
            <img class="recto" src="./Images/vincurc.png" alt="Photo d'une bouteille de vin Jaune Curcuma & Gingembre ">
            <div class="verso">
